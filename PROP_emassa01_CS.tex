...
\title{A User Model for People with Autism in Search }
\author{Esha Massand\\
...
This project will \textbf{integrate} these insights from the Psychology literature with the proposed system.
...
\item The system will utilise motion controllers to enhance embodiment within search, and enhance the search query process. I will investigate the use of the LEAP motion controller as the main device in the first instance.
\end{enumerate}

\subsubsection{Development Milestones}
To achieve my goals I will need to test the system's feasibility. This will include;
\begin{enumerate}
\item Obtaining user feedback on the intital product by testing the web search with the LEAP motion controller, with a group of individuals diagnosed with ASD.
...
2 & Configure back end of the system\\
...
\begin{table}[ht]
\caption{Project Stage 3} 
\centering 
\begin{tabular}{c c}
\hline\hline 
Task \# & Stage 3 \\ [0.5ex]
\hline 
1 & Refine system using feedback \\ 
2 & Write up project \\
...
Need to include user acceptance testing \\
\textbf{Test Driven Development}\\
Unit testing – TDD style\\
Regression testing (testing the project as a whole unit to make sure nothing breaks)\\
\textbf{Project Backlog}
